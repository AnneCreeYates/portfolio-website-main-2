...
- **JavaScript:** Modern **ES modules** (vanilla JS). Entry points are in `src/js` (`main.js`).
...
- **Canvas effects:** Uses the browser Canvas API for the animation.
- **Libraries:** `simplex-noise` (used by animation for organic motion).
